...
if __name__ == '__main__':
    ...
    height = [tiempo_a_toda_maquina, tiempo_a_mano]# en esta línea debes intercambiar las variables, tiempo a mano primero, y luego tiempo a toda máquina, para que el resultado sea correcto
